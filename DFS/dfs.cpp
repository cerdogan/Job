 ...
 * @author Can Erdogan
 * @date July 12, 2015
 * @brief Implementation of depth-first search for the 8-puzzle example in Russell & Norvig AI 
...
stack <State*> states; 	/// A state is a 9 digit number with 0 representing the empty cell
vector <int> actions;
